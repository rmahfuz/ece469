...
#define MEM_L1TABLE_SIZE ((MEM_MAX_VIRTUAL_ADDRESS + 1) >> MEM_L1FIELD_FIRST_BITNUM)  //1024
#define MEM_ADDRESS_OFFSET_MASK (MEM_PAGESIZE - 1) 

#define MEM_L2TABLE_SIZE 0x1 << (MEM_L1FIELD_FIRST_BITNUM - MEM_L2FIELD_FIRST_BITNUM) //256

#define MEM_MAX_L2_PAGETABLES 256 //TOTOAL NUMBER OF L2 TABLE 
